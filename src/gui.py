...
def ui_fragments():
	...
	st.selectbox('fragment size (characters)', [0,200,300,400,500,600,700,800,900,1000,2000,5000,10000,20000], index=3, key='frag_size')
	b_reindex()
...
def b_save():
	...
	if st.button('save encrypted index in ask-my-pdf', help=help):
